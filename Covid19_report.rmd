...
This report will dive into data from Covid19 including the number of cases and deaths in different locations and over time. This dataset is from the Johns Hopkins Github site. 
...
Next, we want to look at the number of new cases and new deaths by day in both the US and Colorado. These will be plotted on a log scale to better see patterns.
